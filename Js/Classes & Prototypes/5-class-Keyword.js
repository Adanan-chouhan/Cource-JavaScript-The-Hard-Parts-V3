...
console.log(user); // secondStudent { studentName: 'Sentence', studentAge: 20 }
user.hello();  // Hello Sentence you age is 20


// inheritance 
class therdStudent extends student{
    address(){
        console.log(`You address is 5th road ,Jodhpur`)
    }
}

const user1 = new therdStudent("Adnan",20);
user1.address(); 